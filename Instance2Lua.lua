...
-- polybundle: module dev/lib/APIDump.module.lua
__module_env["dev/lib/APIDump.module.lua"] = (function()
...
-- polybundle: module dev/lib/TypeResolver.module.lua
__module_env["dev/lib/TypeResolver.module.lua"] = (function()
local resolverFuncs = {}
...
-- polybundle: module dev/lib/GetProperties.module.lua
__module_env["dev/lib/GetProperties.module.lua"] = (function()
...
local APIDump = __module_env["dev/lib/APIDump.module.lua"]
local ResolveType = __module_env["dev/lib/TypeResolver.module.lua"]
local GetProperties = __module_env["dev/lib/GetProperties.module.lua"]
